...
try
{
         Class.forName("com.mysql.jdbc.Driver");
          // edit Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/vijay", "root", "root");
           Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/murali", "root", "abcd");
